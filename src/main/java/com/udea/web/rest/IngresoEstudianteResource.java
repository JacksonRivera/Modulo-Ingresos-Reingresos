...
public class IngresoEstudianteResource {
    ...
    //Metodo que trae la información de ingreso estudiante en base al tipo de ingreso
    @GetMapping("/ingreso-estudiantes/tipoingreso/{tipoIngreso}")
    public List<IngresoEstudiante> getIngresoEstudianteCarrera(@PathVariable String tipoIngreso) {
        List<IngresoEstudiante> ingresoEstudiante = ingresoEstudianteRepository.findByTipoIngreso(tipoIngreso);
        return ingresoEstudiante;
    }

    @GetMapping("/ingreso-estudiantes/fechaingreso/{id}")
    public IngresoEstudiante getIngresoEstudianteFecha(@PathVariable Long id) {
        IngresoEstudiante ingresoEstudiante = ingresoEstudianteRepository.findByCarrera(id);
        return ingresoEstudiante;
    }
