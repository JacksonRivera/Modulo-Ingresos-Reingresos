...
public class CarreraResource {
    ...
    //Traer los datos de una carrera en base a su id y su facultad
    @GetMapping("/carreras/{id}/{nombreFacultad}")
    public Carrera getCarreraIdFacultad(@PathVariable Long id, @PathVariable String nombreFacultad) {
        Carrera carrera = carreraRepository.findByIdAndFacultad(id, nombreFacultad);
        return carrera;
    }

    //Muestra el nombre de las carreras que estan en una facultad
    @GetMapping("/carreras/facultad/{nombreFacultad}")
    public List<Carrera> getCarreraFacultad(@PathVariable String nombreFacultad) {
        List<Carrera> carrera = carreraRepository.findByFacultad(nombreFacultad);
        return carrera;
    }
